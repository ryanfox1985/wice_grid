  ...
  module JsCalendarHelpers #:nodoc:
    ...
    def date_calendar_jquery(calendar_data)  #:nodoc:
      ...
      hidden_field_tag_options = {
        ...
        # 'data-button-image' => asset_path(Wice::ConfigurationProvider.value_for(:CALENDAR_ICON_IN_ASSETS), type: :image),
        'data-button-image' => image_path(Wice::ConfigurationProvider.value_for(:CALENDAR_ICON_IN_ASSETS)),
